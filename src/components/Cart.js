...
export default function Cart() {
    ...
    return (
      <div className="flex py-8">
        ...
        <div className="flex flex-col h-full ml-auto items-end justify-between">
          <div className="h-8">
            <img src="trash.png" className="w-[16px] h-[16px]"></img>
          </div>
          <div className="h-8">
  ...
  return (
    <div className="w-full flex flex-col min-[1000px]:flex-row max-[1000px]:items-center min-[1000px]:justify-center mb-8 space-x-0 min-[1000px]:space-x-8 space-y-8 min-[1000px]:space-y-0">
      <div className="w-1/2 min-w-[350px] max-w-[750px] text-center card">
      ...
      <div className="w-1/3 min-w-[350px] max-w-[750px] h-fit flex flex-col text-center card">
