...
export default function Cart() {
  ...
  function CartItem() {
    ...
    return (
      <div className="flex py-8">
        <img src="shirt.png" className="w-[100px] h-[140px] mr-4 bg-gray-100 border border-gray-300 rounded-md" alt="product"></img>
        ...
        <div className="flex flex-col h-full ml-auto items-end justify-between">
          <div className="h-8">
            <img src="trash.png" className="w-[16px] h-[16px] cursor-pointer" alt="trash"></img>
          </div>
          <div className="h-8">
  ...
  return (
    <div className="w-full flex flex-col xl:flex-row items-center xl:items-start xl:justify-center space-x-0 xl:space-x-8 space-y-8 xl:space-y-0">
      ...
      <div className="w-4/5 xl:w-1/4 min-w-[350px] max-w-[750px] h-fit flex flex-col text-center card">
